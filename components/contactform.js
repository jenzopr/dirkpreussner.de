        ...
        <form onSubmit={sendMail} className="mt-4 space-x-2 space-y-2">
          <div className='grid gap-y-1 gap-x-2 lg:grid-cols-2'>
            ...
            <div className="mt-2 lg:col-span-2">
              <button disabled={status != 'ready'} className={`w-full justify-center text-white font-normal py-2 px-6 lg:px-8 xl:py-3 rounded shadow inline-flex items-center ${status != 'sent' ? "bg-burgund-600 hover:bg-burgund-700 disabled:cursor-wait disabled:bg-burgund-700" : "bg-burgund-700 cursor-not-allowed"}`}>
