            ...
            <Section className="bg-white">
                <div className="flex flex-col max-w-3xl pb-8 xl lg:py-16 text-gray-900 text-sm">
                    ...
                    <h2 className="text-xl mt-2 mb-1">Diensteanbieter</h2>
                        ...
                        <p className="">c/o Psychotherapeutische Praxisgemeinschaft</p>
                        <p className="">Kaiserstraße 69</p>
                        <p className="">60329 Frankfurt am Main</p>
                    <h2 className="text-xl mt-2 mb-1">Kontaktmöglichkeiten</h2>
                        <p>E-Mail-Adresse: hallo@dirkpreussner.de</p>
                        <p className="mt-2">Kontaktformular auf der <Link href="/" className="underline text-burgund-600">Startseite</Link></p>
                    <h2 className="text-xl mt-2 mb-1">Bildnachweise</h2>
                        ...
                        <ul className="mt-2 pl-8 list-disc">
                            <li>Kopfgrafik <Link href="/" className="underline text-burgund-600">Startseite</Link>: Dominik Bingel</li>
                            <li>Stock-Fotos <Link href="/workshops-moderation" className="underline text-burgund-600">Workshops</Link>: pixabay, unsplash, Dirk Preußner</li>
                        </ul>
